      ...
      <main>
        ...
        <Section>
          ...
          <label className="block text-gray-600 mb-2">
            The dataset has been preprocessed to identify drug entities and
            their interactions in biomedical texts. Sentences were tokenized,
            drug entities were annotated with unique identifiers, and
            interaction pairs were labeled according to their type. The dataset
